      ...
      <div className="max-w-4xl mx-auto text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto">
            Your secure cloud file storage solution. Upload, organize, and
            ...
            <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4 mx-auto">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M3 7v10a2 2 0 002 2h14a 2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"
                />
              </svg>
            </div>
            <h3 className="font-semibold text-lg mb-2">Organized</h3>
            <p className="text-gray-600 text-sm">
              Create folders and keep your files organized
            </p>
          </div>
